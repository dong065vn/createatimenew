const vi = {
  ...
  "eventList": {
    ...
    "import": "Nhập",
    "import_success": "Đã nhập thành công {{count}} sự kiện.",
    "import_error": "Nhập thất bại. Vui lòng kiểm tra định dạng file.",
    "import_error_format": "Định dạng file không được hỗ trợ. Vui lòng sử dụng file JSON hoặc ICS.",
    "export_ics": "Xuất ICS",
